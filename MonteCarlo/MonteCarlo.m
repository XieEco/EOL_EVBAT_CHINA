...
load('main.mat', 'ccjgz', 'co2a', 'costa')
% FIG5A
figure
x1=YH_result_COST-costa(1,1);
y1=YH_result_CO2-co2a(1,1);
scatter(x1,y1,1,'MarkerFaceColor',[166 166 166]./256,'MarkerEdgeColor',[180 180 180]./256,'LineWidth',0.2);
hold on;
size=120;
scatter(ccjgz(1,1),ccjgz(1,2),size,'filled','MarkerEdgeColor',[0 0 0]./256,'MarkerFaceColor',[233 174 104]./256,'LineWidth',1);% LOW-COL
hold on;
scatter(ccjgz(2,1),ccjgz(2,2),size,'filled','MarkerEdgeColor',[0 0 0]./256,'MarkerFaceColor',[94 148 209]./256,'LineWidth',1);% LOW-DRT
hold on;
scatter(ccjgz(3,1),ccjgz(3,2),size,'filled','MarkerEdgeColor',[0 0 0]./256,'MarkerFaceColor',[212 50 104]./256,'LineWidth',1);% LOW-B2U
hold on;
scatter(ccjgz(4,1),ccjgz(4,2),size,'filled','MarkerEdgeColor',[0 0 0]./256,'MarkerFaceColor',[0 176 80]./256,'LineWidth',1);% LOW-BAL
hold on;
scatter(ccjgz(5,1),ccjgz(5,2),size, 'D','filled','MarkerEdgeColor',[0 0 04]./256,'MarkerFaceColor',[233 174 104]./256,'LineWidth',1);% MID-COL
hold on;
scatter(ccjgz(6,1),ccjgz(6,2),size, 'D','filled','MarkerEdgeColor',[0 0 0]./256,'MarkerFaceColor',[94 148 209]./256,'LineWidth',1);% MID-DRT
hold on;
scatter(ccjgz(7,1),ccjgz(7,2),size, 'D','filled','MarkerEdgeColor',[0 0 0]./256,'MarkerFaceColor',[212 50 104]./256,'LineWidth',1);% MID-B2U
hold on;
scatter(ccjgz(8,1),ccjgz(8,2),size, 'D','filled','MarkerEdgeColor',[0 0 0]./256,'MarkerFaceColor',[0 176 80]./256,'LineWidth',1);% MID-BAL
hold on;
scatter(ccjgz(9,1), ccjgz(9,2),size, 'V','filled','MarkerEdgeColor',[0 0 0]./256,'MarkerFaceColor',[233 174 104]./256,'LineWidth',1);% HIG-COL
hold on;
scatter(ccjgz(10,1),ccjgz(10,2),size, 'V','filled','MarkerEdgeColor',[0 0 0]./256,'MarkerFaceColor',[94 148 209]./256,'LineWidth',1);% HIG-DRT
hold on;
scatter(ccjgz(11,1),ccjgz(11,2),size, 'V','filled','MarkerEdgeColor',[0 0 0]./256,'MarkerFaceColor',[212 50 104]./256,'LineWidth',1);% HIG-B2U
hold on;
scatter(ccjgz(12,1),ccjgz(12,2), size,'V','filled','MarkerEdgeColor',[0 0 0]./256,'MarkerFaceColor',[0 176 80]./256,'LineWidth',1);% HIG-BAL
hold on;
b=kkk;
...
scatter(YH_result_COST(1,lowest_cost)-costa,YH_result_CO2(1,lowest_cost)-co2a,size.*2,'kp','LineWidth',1,'MarkerFaceColor','r');
hold on;
xlabel('Cumulative cost change (B RMB)','FontName','Times New Roman','FontWeight','bold','FontSize',18)
ylabel('Cumulative GHG change (Mt CO_2eq)','FontName','Arial','FontWeight','bold','FontSize',18)
box on
xlim([-5000,0]);
ylim([-7000,0]);
set(gca, 'TickLength', [0, 0]); 
set(gca, 'XTick', -5000:1000:0);  
set(gca, 'YTick', -7000:1000:0);  
ax = gca; 
ax.LineWidth = 1.5;
ax.XColor = 'k'; 
ax.YColor = 'k'; 
